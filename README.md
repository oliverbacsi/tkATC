...
>* If multiple actions are required within one single game step, then they should be separated by **commas**.  
>  See above: `task3/1` and `task3/2` are executed in the same step
